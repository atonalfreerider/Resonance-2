...
public static class OrreryValidation
{
    ...
    public static async void Run()
    {
        ...
        async Task Click(string text)
        {
            ...
            scroll.ScrollTo(button);button.Focus();await Task.Delay(100);
        ...
        try
        {
            ...
            Check(Math.Abs(midi.Position-midi.Cycles.SecondsAt(midi.SongForm.Sections[1].Start))<.001,"Section navigation seeks the MIDI transport");

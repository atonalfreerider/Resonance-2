...
public static class Perf
{
    public static readonly ProfilerMarker
        ...
        Vocal=new("Resonance.LyricWheel.Vocal"),Words=new("Resonance.LyricWheel.Words"),Board=new("Resonance.LyricWheel.Board"),
    ...
    public static readonly string[] Names=
    {
        ...
        "Resonance.LyricWheel.Vocal","Resonance.LyricWheel.Words","Resonance.LyricWheel.Board","Resonance.DrumLyricRack","Resonance.DrumPatternDeck","Resonance.MidiPlayer","Resonance.HarmonyExplorer",

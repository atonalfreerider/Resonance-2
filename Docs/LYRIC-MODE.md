...
- **Unity** (Tools → Resonance → Check lyric mode and instrument changers, in Play Mode):
  ...
  - a syllable is set in the chord's colour, and its white strike is gone 0.3 s after it lands;
